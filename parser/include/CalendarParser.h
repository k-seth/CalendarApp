...
char *createCalendarFromJSON(char *, char *, char *);
char *addEventFromJSON(char *, char *);
int callValidateCalendar(char *);
char *getCalJSON(char *);
char *getEventsJSON(char *);
char *getEvtAlarms(char *, char *);
char *getEvtProps(char *, char *);
